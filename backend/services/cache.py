...
_callgraph_cache: dict[str, "CallGraphResult"] = {}

def get_cached_callgraph(repo_name: str):
    return _callgraph_cache.get(repo_name)

def set_cached_callgraph(repo_name: str, result):
    _callgraph_cache[repo_name] = result